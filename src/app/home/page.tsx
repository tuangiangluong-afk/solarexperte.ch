...
import { Zap, Award, ArrowRight, Home, CheckCircle, Thermometer } from "lucide-react";
...
export const metadata = {
    title: "Wärmepumpe Experte | Ihr Wärmepumpen-Portal",
    description: "Sichern Sie sich bis zu 70% BAFA Förderung für Ihre neue Wärmepumpe. Kostenlose Angebote von zertifizierten Heizungsbauern.",
};
        ...
        <div className="min-h-screen font-sans text-slate-900 bg-white">
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center pt-8">
                        <div className="lg:col-span-7 flex flex-col gap-8 text-center lg:text-left">
                            <div>
                                <div className="inline-flex items-center rounded-full border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-bold text-amber-700 mb-6">
                                    ...
                                    Staatlich gefördert durch BAFA / KfW
                                </div>
                                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
                                    Heizen mit Zukunft: <span className="text-amber-500">Wärmepumpe</span> installieren & Kosten senken.
                                </h1>
                                <p className="text-xl text-slate-600 mb-4 max-w-xl mx-auto lg:mx-0">
                                    <strong>Bis zu 70% staatliche Zuschüsse sichern.</strong> Holen Sie sich kostenlose Angebote von Fachbetrieben in Ihrer Region.
                                </p>
                            </div>
                        ...
                        <div className="lg:col-span-5 flex flex-col justify-center">
                            <div className="relative h-[300px] lg:h-[450px] w-full rounded-2xl overflow-hidden border bg-white">
                                <Image
                                    src="/images/generated/pac-hero.webp"
                                    alt="Wärmepumpe"
                                    fill
            ...
            <section className="py-16 bg-slate-50">
                <div className="max-w-6xl mx-auto px-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Wärmepumpen-Installateure in Ihrer Stadt</h2>
