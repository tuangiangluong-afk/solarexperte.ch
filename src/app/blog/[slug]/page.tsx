...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
    ...
    if (!post) {
        return { title: 'Article non trouvé | Wärmepumpe Experte' };
    }

    return {
        title: post.seo_title || `${post.title} | Wärmepumpe Experte`,
        ...
        openGraph: {
            ...
            authors: [post.author_name || 'Wärmepumpe Experte'],
        },
    };
}
...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const schema = {
        ...
        "author": {
            "@type": "Person",
            "name": post.author_name || "Wärmepumpe Experte"
        }
    };
                    ...
                    <aside className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-white border border-neutral-200 rounded-2xl p-6 shadow-sm">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-neutral-900">{post.author_name || 'Wärmepumpe Experte'}</p>
