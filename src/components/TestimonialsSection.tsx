...
export default function TestimonialsSection() {
    const testimonials = [
        {
            quote: "Die Wärmepumpen-Beratung war hervorragend. Wir erhielten innerhalb kürzester Zeit Angebote von Heizungsbauern aus unserer Region. Der Einbau lief reibungslos und die BAFA-Förderung wurde komplett für uns beantragt.",
            name: "Andreas Schmid",
            location: "München",
            product: "Luft-Wasser-Wärmepumpe 12 kW",
            initials: "AS"
        },
        {
            quote: "Unsere alte Gasheizung wurde durch eine effiziente Wärmepumpe ersetzt. Trotz kaltem Winter in Berlin heizt das Haus tadellos. Die Heizkostenersparnis ist bereits deutlich spürbar.",
            name: "Sabine Weber",
            location: "Berlin",
            product: "Wärmepumpe Premium",
            initials: "SW"
        }
    ];
        ...
        <section className="bg-slate-900 text-white py-16 lg:py-24 overflow-hidden relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-16 relative z-10">
                <div className="flex-1 flex flex-col gap-8">
                    <h2 className="text-2xl md:text-3xl font-bold">Wärmepumpen-Fachbetriebe deutschlandweit</h2>
